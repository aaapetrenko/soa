...
type ReverseClient interface {
	Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*SResponse, error)
	Answer(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
	Exit(ctx context.Context, in *Request, opts ...grpc.CallOption) (*SResponse, error)
}
...
func (c *reverseClient) Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*SResponse, error) {
	out := new(SResponse)
	err := c.cc.Invoke(ctx, "/mafia.Reverse/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reverseClient) Answer(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/mafia.Reverse/Answer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reverseClient) Exit(ctx context.Context, in *Request, opts ...grpc.CallOption) (*SResponse, error) {
	out := new(SResponse)
...
type ReverseServer interface {
	Do(context.Context, *Request) (*SResponse, error)
	Answer(context.Context, *Request) (*Response, error)
	Exit(context.Context, *Request) (*SResponse, error)
...
func (UnimplementedReverseServer) Do(context.Context, *Request) (*SResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Do not implemented")
}
func (UnimplementedReverseServer) Answer(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Answer not implemented")
}
func (UnimplementedReverseServer) Exit(context.Context, *Request) (*SResponse, error) {
...
func _Reverse_Answer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mafia.Reverse/Answer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReverseServer).Answer(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
